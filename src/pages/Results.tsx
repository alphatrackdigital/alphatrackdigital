...
const Results = () => {
  return (
    <>
      ...
      <main className="bg-[#05070d] pt-[70px]">
        <section className="relative flex min-h-[calc(100svh-70px)] items-center justify-center overflow-hidden border-b border-white/10 py-16 md:py-20">
          ...
          <div className="container relative mx-auto px-6 lg:px-8">
            <div className="mx-auto max-w-3xl -translate-y-8 text-center md:-translate-y-10">
