...
const ThankYou = () => {
  return (
    ...
    <section className="relative flex min-h-[80vh] items-center justify-center py-24">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] rounded-full bg-[radial-gradient(circle,rgba(0,175,239,0.06)_0%,rgba(0,51,153,0.08)_34%,transparent_70%)] pointer-events-none" />
