...
const steps = [
  {
    ...
    text: (
      <>
        <strong className="text-foreground">Check your inbox</strong> - You'll receive a calendar
        invite with a video call link from Brevo Meetings.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <strong className="text-foreground">No prep needed</strong> - We'll ask about your current
        tracking setup and goals on the call. Just show up.
      </>
    ),
  },
  {
    ...
    text: (
      <>
        <strong className="text-foreground">Get a clear next step</strong> - After the call, we'll
        send you a summary with our recommendations.
      </>
    ),
  },
];
...
const ThankYou = () => {
  return (
    <>
      <SEO
        title="Call Booked | AlphaTrack Digital"
        description="Your discovery call has been confirmed."
        canonicalUrl="/book-a-call/thank-you"
        noindex
      />
        ...
        <div className="container relative mx-auto px-4 lg:px-8">
          <div className="mx-auto max-w-xl text-center">
            ...
            <p className="mt-3 text-lg leading-relaxed text-muted-foreground">
              Your discovery call has been confirmed. Check your email for the calendar invite with
              the meeting link.
            </p>
            ...
            <div className="mt-10 rounded-2xl border border-white/[0.06] bg-white/[0.03] p-8 text-left">
              ...
              {steps.map((step) => (
                <div
                  key={step.num}
                  className="flex items-start gap-3.5 border-b border-white/[0.04] py-3 last:border-0"
                >
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
              <Button asChild className="gap-2 rounded-lg bg-primary font-bold text-primary-foreground hover:bg-primary/90">
